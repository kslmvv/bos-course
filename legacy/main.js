// ─── Backend API ──────────────────────────────────────────────────────
// This is the "legacy" copy of the frontend, served only to @bos_course_bot
// (the bot being migrated away from — see bos-bot-legacy on Railway). It
// points at a separate backend deployment so that bot's users keep working
// (initData is only valid against the token of the bot that issued it)
// during the migration window to @BilimBook_bot. Delete this folder once
// the old bot is retired.
var API_BASE = 'https://bos-bot-legacy-production.up.railway.app';
